        ...
        <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,theme(colors.slate.400/.25),transparent)1] md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-4 text-center md:pb-12">
            ...
            <p className="text-lg text-indigo-200/65">
             VERACITY UNDERSTANDS YOUR PROBLEMS AND WILL BE THE SOLUTION TO MAKING LIFE SAFER
            </p>
          </div>
          ...
          <div className="mx-auto grid max-w-sm gap-12 sm:max-w-none sm:grid-cols-2 md:gap-x-14 md:gap-y-16 lg:grid-cols-3">
            ...
            <article>
              ...
              <p className="text-indigo-200/65">
                Track progress across custom flows for the user, privacy and security.
              </p>
            </article>
            <article>
              <svg
            ...
            <article>
              ...
              <p className="text-indigo-200/65">
              We aim to educate people abou the importance of their medical history and how it can misused through various classes.
              </p>
            </article>
            <article>
              <svg
              ...
              <h3 className="mb-1 font-nacelle text-[1rem] font-semibold text-gray-200">
YOUR DATA IS SAFE              </h3>
              <p className="text-indigo-200/65">
                Your data is in your own hands. We use highest security to ensure privacy and security.
              </p>
            </article>
            <article>
              <svg
              ...
              <p className="text-indigo-200/65">
                The data will not be destroyed in any way.
              </p>
            </article>
          </div>
        </div>
